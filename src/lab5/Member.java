...
public class Member {
    ...
    public void borrowBook(Book book) {
        ...
        BorrowingBookResult borrow = borrowService.borrowBook(this, book);
        System.out.println(borrow.getBorrowingMessage());

    }

    public void returnBook(Book book) {
        borrowingService borrowService = new borrowingService();
        BorrowingBookResult borrow = borrowService.returnBook(this, book);
        System.out.println(borrow.getBorrowingMessage());
